...
import {GenerateRpToken} from '@app/pages/relyingParties/RpTokenGeneration/RpTokenGeneration.reducer';
...
const reducers = combineReducers({
    ...
    generateRpToken: GenerateRpToken.reducer,
